...
bool init_stivale2(struct stivale2_struct *bootloaderdata, GlobalBootParams *params)
{
    init_serial(COM1);
    serial_write_text(COM1, "Initializing Stivale2...\n");
    static uint64_t MemorySizeBytes = 0;
    static int mmaptmpcount = 0;
    ...
    debug("Current PML is at address: %016p", readcr3());
    ...
    {
        warn("Memory map entries mismatch. %016p != %016p",
